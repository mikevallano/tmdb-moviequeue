      ...
      default_providers = [
        {
          name: 'Netflix',
          pay_model: 'try',
          url: "http://www.netflix.com/search/#{movie.title}"
        },
        {
          name: 'Amazon Prime Video',
          pay_model: 'try',
          url: "https://smile.amazon.com/s?k=#{movie.title.gsub(' ', '+')}&i=instant-video"
        },
        {
          name: 'Amazon Video',
          pay_model: 'try',
        ...
        },
        {
          name: 'YouTube',
          pay_model: 'try',
          url: "https://www.youtube.com/results?search_query=#{movie.title}+full+movie #{movie.release_date.stamp('2001') if movie.release_date.present?}"
        },
        {
          name: 'Vudu',
          pay_model: 'try',
          url: "https://www.vudu.com/content/movies/search?searchString=#{movie.title}"
        },
      ]
